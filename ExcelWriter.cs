...
namespace CourseWork3year
{
    public static class ExcelWriter
    {
        ...
        public static void OutputSizeToTimeComparison(List<long> tripleGreedy, List<long> avarageGreedy, List<int> sizes, string message)
        {
            ...
            serie2.Header = "Час сер. жадібного (ms)";
        ...
        public static void OutputSizeToPrecisionComparison(List<double> tripleGreedy, List<double> avarageGreedy, List<int> sizes, string message)
        {
            worksheet.Cells[currentRow, 1].Value = message;
            ...
            // Виводимо другу криву
            var serie2 = chart.Series.Add(worksheet.Cells[currentRow + 2, 2, currentRow + 2, tripleGreedy.Count + 1], worksheet.Cells[currentRow, 2, currentRow, tripleGreedy.Count + 1]);
            serie2.Header = "Сер. відхилення сер. жадібного";
